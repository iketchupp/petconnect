  ...
  const onDrop = useCallback(
    (acceptedFiles: File[]) => {
      ...
      if (validFiles.length !== acceptedFiles.length) {
        toast.error('Some files were rejected. Images must be less than 20MB and in JPG, PNG, or WebP format.');
      }
  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        <p className="text-muted-foreground text-sm">JPG, PNG or WebP, up to 20MB each (maximum {MAX_IMAGES} images)</p>
      </div>
