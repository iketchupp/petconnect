...
export function AddressForm({
  ...
  const handlePlaceSelect = useCallback(
    (place: GoogleMapsTypes.places.PlaceResult) => {
      ...
      form.setValue(`${fieldPrefix}.address1`, address1);
      form.setValue(`${fieldPrefix}.city`, city);
      form.setValue(`${fieldPrefix}.region`, region);
      form.setValue(`${fieldPrefix}.postalCode`, postalCode);
      form.setValue(`${fieldPrefix}.country`, country);

      if (place.geometry && place.geometry.location) {
        form.setValue(`${fieldPrefix}.lat`, place.geometry.location.lat());
        form.setValue(`${fieldPrefix}.lng`, place.geometry.location.lng());
      }
